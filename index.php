<?php
	...
	$_SESSION['Pages'] = array(	
		...
		array("id"=>2,"meta-title"=>"Other","meta-description"=>"Some more stuff we think is neat.","path-ui"=>"/pg/about/barbara","path-file"=>"/page/about/barbara.php"),
...
<html lang="en">
    <head>
        ...
        <?php
			...
			echo "<title>The Impact Seat - ".$_SESSION['Page']['meta-title']."</title><meta name=\"description\" content=\"".$_SESSION['Page']['meta-description']."\">";
        ...
        <div id="page" class="container-fluid">
                ...
                <nav class="navbar navbar">
                    <div id="head" class="container-fluid col-lg-10 col-lg-offset-1">
                        <div class="navbar-header col-sm-12 col-md-12 col-lg-4">
                            ...
                            <a class="navbar-brand" href="/pg/index" target="#content"><img src="/img/logo.png" alt="The Impact Seat" /></a>
                        </div>
            ...
            <div id="footer" class="row">
                <div class="col-md-10 col-md-offset-1 col-lg-3 col-lg-offset-1">
                    <p>info@impactseat.com<br>(857)230-0396</p>
                    <p><a href="https://twitter.com/ImpactSeat" target="_blank"><img src="/img/twitter.svg" alt="Twitter" /></a><a href="https://www.facebook.com/ImpactSeat/" target="_blank"><img src="/img/facebook.svg" alt="Facebook" /></a><a href="https://www.linkedin.com/m/company/10867780/" target="_blank"><img src="/img/linkedin.svg" alt="LinkedIn" /></a></p>
                </div>
                <div class="col-md-12 col-lg-7" id="fmenu"><?php $_REQUEST['dd'] = 0; include("menu.php"); ?></div>
                <div class="col-md-12 text-center" style="margin-top:50px;"><p style="font-size:9px;">&copy;The Impact Seat 2016 - All Rights Reserved</p><a href="http://www.kburkhart.com" target="_blank"><img src="/img/KBDicon.svg" alt="Katharine Burkhart Designs" /></a></div>
            </div>
        </div>
        <!--End Page-->
        <!-- Start WWU Modal -->
        <div class="modal fade" id="WWUModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="WWUForm" role="form">
                            <input type="text" title="Full Name" name="name" value="Full Name">
                            <input type="text" title="Company" name="company" value="Company">
                            <input type="text" title="Email Address" name="email" value="Email">
                            <textarea title="Message" name="message" rows="4" cols="20">Message</textarea>
				...
				$(document).ready(function(){
					...
					$.ajax({
						...
						$(window).on("message", function(event) {
							...
							if(event.originalEvent.origin !== "http://wordpress.impactseat.com"){ return; } 
							...
							if(event.originalEvent.data[1] && page.includes("/pg/blog")){ window.history.pushState({"html":$("#content").html(),"url":"/page/blog"+encodeURI(event.originalEvent.data[1].replace("/index.php",""))},"","/pg/blog"+encodeURI(event.originalEvent.data[1].replace("/index.php",""))); /*updatePermalinkVar("a",encodeURI(event.originalEvent.data[1].replace("/index.php","")));*/ }
