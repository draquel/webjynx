...
/*DEBUG OUTPUT::*/
	...
	$medias = $_SESSION['Media']->getRelPage($_SESSION['db']->con($_SESSION['dbName']),$pageNum,"Gallery",$_REQUEST['pg']);
	...
	$nextPN = $pageNum + 1;if($_SESSION['Media']->getRelPage($_SESSION['db']->con($_SESSION['dbName']),$nextPN,"Gallery",ucfirst($_REQUEST['pg']))->size() > 0){ $last = false; }else{ $last = true; }
